...
console.log(gameCard);
 ...
 let shuffledChild = Array.from(gameCard).sort(() => 0.5 - Math.random());  // this will give the random position of the elemenet in every time.
...
// step 4  due to this we click only 2 time.
